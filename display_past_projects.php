...
if (isset($_GET['project_id'])) {
    ...
    $query = "SELECT * FROM project WHERE project_id = $project_id AND (status = 'cancelled' OR status = 'completed')";  $result = mysqli_query($con, $query);    $result = mysqli_query($con, $query);
    if (!$result) {
