...
$query = "SELECT * FROM project WHERE status = 'in_progress'";
...
?>
        <a href="display_existing_projects.php?project_id=<?php echo $project_id ?>" style="text-decoration: none; color: black;">
            <article>
